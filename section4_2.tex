...
% また，先行研究\cite{choi2023intelligible}においては学習時に，メルスペクトログラムにノイズを付与するデータ拡張手法が提案されている．本研究では，動画から予測されるメルスペクトログラムとHuBERT離散特徴量の予測精度向上に焦点を当てたため，ボコーダの学習は原音声から計算される特徴量で行い，ボコーダ自体の汎化性能向上による精度改善は追求しなかった．
