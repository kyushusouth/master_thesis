...
\begin{equation}
    \lossFuncUpper_{\text{MAE}}(\bm{\outputLower}, \hat{\bm{\outputLower}}) = \frac{1}{\dimUpper} \sum_{\dimLower = 1}^{\dimUpper}  |\outputLower_{\dimLower} - \hat{\outputLower}_{\dimLower}|
\end{equation}
...
\begin{equation}
    \lossFuncUpper_{\text{MAE}}(\bm{\outputUpper}, \hat{\bm{\outputUpper}}) = \frac{1}{\dimUpper \timeUpper} \sum_{\dimLower = 1}^{\dimUpper} \sum_{\timeLower = 1}^{\timeUpper}  |\outputLower_{\dimLower, \timeLower} - \hat{\outputLower}_{\dimLower, \timeLower}|
\end{equation}
で与えられる．
...
\begin{equation}
    \lossFuncUpper_{\text{CE}}(\bm{\outputLower}, \hat{\bm{\outputLower}}) = - \sum_{\classLower = 1}^{\classUpper} y_{\classLower} \log \frac{\exp(\hat{\outputLower}_{c})}{\sum_{i = 1}^{C} \exp(\hat{\outputLower}_{c})}
\end{equation}
...
\begin{equation}
    \lossFuncUpper_{\text{CE}}(\bm{\outputUpper}, \hat{\bm{\outputUpper}}) = - \frac{1}{\timeUpper} \sum_{\timeLower = 1}^{\timeUpper} \sum_{\classLower = 1}^{\classUpper} y_{\classLower, t} \log \frac{\exp(\hat{\outputLower}_{\classLower, t})}{\sum_{i = 1}^{C} \exp(\hat{\outputLower}_{\classLower, t})}
\end{equation}
で与えられる．
...
\end{equation}
で与えられる．$\mathcal{\indexUpper}$は学習データセット$\datasetTrain$における話者$s_{n}$と話者が同一のデータのインデックスからなる集合，すなわち
\begin{equation}
    \mathcal{\indexUpper} = \{\indexLower \mid \indexLower \in \{1, \ldots, N\}, ~ s_{\indexLower} = \spkId\}
\end{equation}
