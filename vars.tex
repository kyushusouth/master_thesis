...
\newcommand{\myNetworkSpkMerge}{f_{\text{spk-merge}}}
\newcommand{\myNetworkPost}{f_{\text{post}}}
\newcommand{\myNetworkFcMel}{f_{\text{fc-mel}}}
\newcommand{\myNetworkFcHubDisc}{f_{\text{fc-HuB-disc}}}
\newcommand{\myNetworkFcHubInt}{f_{\text{fc-HuB-int}}}
...
% \newcommand{\featureAVHuBERT}{\bm{\featureUpper}^{\text{AVHuB}}_{\numLower}}
% \newcommand{\featureWithSpkA}{\bm{\featureUpper}^{\text{w-spk-A}}_{\numLower}}
% \newcommand{\featurePostA}{\bm{\featureUpper}^{\text{post-A}}_{\numLower}}
\newcommand{\featureASet}{\realSet^{\dimUpper^{\text{A}} \times \timeUpper^{\text{video}}_{\numLower}}}
\newcommand{\featureB}{\bm{\featureUpper}^{\text{B}}_{\numLower}}
% \newcommand{\featureHuBERT}{\bm{\featureUpper}^{\text{HuB}}_{\numLower}}
% \newcommand{\featureWithSpkB}{\bm{\featureUpper}^{\text{w-spk-B}}_{\numLower}}
% \newcommand{\featurePostB}{\bm{\featureUpper}^{\text{post-B}}_{\numLower}}
